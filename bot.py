...
# (remove this after) please use spectrum beta just to make sure it runs right although
# you probably are anyways
...
class Spectrum_Bot(commands.AutoShardedBot):
    def __init__(self):
        ...
        # client user is n0w self e.g len(self.guilds)
    ...
    def initiate_start(self):
        ...
        try:
            ...
            print(f"\nAn Error Occurred In The Main Process, Error:\n{e}")
